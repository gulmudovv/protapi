...
var file_protoapi_proto_rawDesc = []byte{
	...
	,
...
var file_protoapi_proto_goTypes = []any{
	...
	(*RandomPass)(nil),      // 4: RandomPass
	(*RequestPass)(nil),     // 5: RequestPass
}
var file_protoapi_proto_depIdxs = []int32{
	...
	5, // 2: Random.GetRandomPass:input_type -> RequestPass
	2, // 3: Random.GetDate:output_type -> DateTime
	1, // 4: Random.GetRandom:output_type -> RandomInt
	4, // 5: Random.GetRandomPass:output_type -> RandomPass
...
func file_protoapi_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protoapi_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_protoapi_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_protoapi_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_protoapi_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_protoapi_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_protoapi_proto_msgTypes[5].Exporter = func(v any, i int) any {
